...
public  final class CSRFTokenResponse extends
  ...
  /**
   * <code>optional string csrf_token = 2;</code>
   */
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!getCsrfTokenBytes().isEmpty()) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 2, csrfToken_);
    }
  }
  ...
  public int getSerializedSize() {
    ...
    if (!getCsrfTokenBytes().isEmpty()) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(2, csrfToken_);
    }
    memoizedSize = size;
    return size;
  }
