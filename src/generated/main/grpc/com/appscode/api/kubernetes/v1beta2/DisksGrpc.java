...
public final class DisksGrpc {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    MethodHandlers(DisksImplBase serviceImpl, int methodId) {
  ...
  private static final class DisksDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    @java.lang.Override
  ...
  public static io.grpc.ServiceDescriptor getServiceDescriptor() {
    ...
    if (result == null) {
      synchronized (DisksGrpc.class) {
        result = serviceDescriptor;
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new DisksDescriptorSupplier())
