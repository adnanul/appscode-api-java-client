...
public final class CredentialsGrpc {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    MethodHandlers(CredentialsImplBase serviceImpl, int methodId) {
  ...
  private static final class CredentialsDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    @java.lang.Override
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.appscode.api.credential.v1beta1.CredentialProto.getDescriptor();
    }
  }
  ...
  public static io.grpc.ServiceDescriptor getServiceDescriptor() {
    ...
    if (result == null) {
      synchronized (CredentialsGrpc.class) {
        result = serviceDescriptor;
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new CredentialsDescriptorSupplier())
              .addMethod(METHOD_LIST)
              .addMethod(METHOD_DESCRIBE)
              .addMethod(METHOD_CREATE)
              .addMethod(METHOD_UPDATE)
              .addMethod(METHOD_IS_AUTHORIZED)
