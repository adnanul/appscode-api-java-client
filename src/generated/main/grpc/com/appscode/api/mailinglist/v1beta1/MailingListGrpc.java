...
public final class MailingListGrpc {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    MethodHandlers(MailingListImplBase serviceImpl, int methodId) {
  ...
  private static final class MailingListDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    @java.lang.Override
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.appscode.api.mailinglist.v1beta1.MailingListProto.getDescriptor();
    }
  }
  ...
  public static io.grpc.ServiceDescriptor getServiceDescriptor() {
    ...
    if (result == null) {
      synchronized (MailingListGrpc.class) {
        result = serviceDescriptor;
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new MailingListDescriptorSupplier())
              .addMethod(METHOD_SEND_EMAIL)
